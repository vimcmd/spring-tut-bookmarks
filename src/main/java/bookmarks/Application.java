...
public class Application {
    ...
    // Once started, Spring Boot will call all beans of type 'CommandLineRunner', giving them a callback.
    // In this case, 'CommandLineRunner' is an interface with one abstract method,
    // which means we can substitute its definition (with lambda expression in this case).
    @Bean
